...
public class colorcountingPlugin_ implements PlugInFilter
{
 ...
 if(rgb_array[0] == 255 && rgb_array[1] ==   0 && rgb_array[2] ==
0) r_counter++;
 if(rgb_array[0] ==   0 && rgb_array[1] == 255 && rgb_array[2] ==
0) g_counter++;
 if(rgb_array[0] ==   0 && rgb_array[1] ==   0 && rgb_array[2] ==
255) b_counter++;
 if(rgb_array[0] ==   0 && rgb_array[1] ==   0 && rgb_array[2] ==
0) k_counter++;
 if(rgb_array[0] == 255 && rgb_array[1] == 255 && rgb_array[2] ==
255) w_counter++;
 }
 }
 IJ.log("RED: ");
